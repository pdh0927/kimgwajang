...
// 임시 민원 데이터
final List<Complaint> uncompletedComplaints = [
  Complaint(
    id: '1241dfaf',
    title: '도로 포트홀 문제',
    content: '우리 동네 길에 큰 포트홀이 생겼습니다. 바퀴가 깨질 것 같아서 걱정입니다. 빠르게 조치 부탁드립니다.',
    reply: '',
    categoryType: CategoryType.CULTURE_AND_TOURISM_AND_SPORTS,
    imagePath: '',
  ...
  Complaint(
    ...
    reply: '',
    categoryType: CategoryType.FIRE_AND_SAFETY,
    imagePath: '',
  ...
  Complaint(
      ...
      categoryType: CategoryType.INDUSTRY_AND_ECONOMY,
      imagePath: ''),

];

final List<Complaint> completedComplaints = [
  Complaint(
      id: '5fad1dfaf',
      title: '불량 주차 신고',
  ...
  ComplaintModel(
      ...
      categoryType: CategoryType.WELFLARE,
      imagePath: ''),
